...
# MyNotes
#alist did change when we modified it inside the
#function.
#a value did not change it when we modified it 
#inside the function.

#alist is assigned by reference:
#that's why:
#we defined it.
#we changed it.
#it kept changed.

#The reference variable keeps its value because
#it is a reference for a memory slot - and since
#that has been changed, the variable then changes.
