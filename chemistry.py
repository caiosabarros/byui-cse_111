...
def main():
    ...
    print(f"The compound is {get_formula_name(formula, known_molecules_dict)}")
    ...
    total_atomic_mass = compute_molar_mass(compound_list,periodic_table)

    # Compute the number of moles in the sample.
    n_moles = mass_in_grams / total_atomic_mass

    # Print the molar mass.
    print(f"{total_atomic_mass:.5f} grams/mole")


    # Print the number of moles.
    print(f"{n_moles:.5f} moles")
