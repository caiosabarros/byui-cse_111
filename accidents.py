        ...
        with open(filename, "rt") as text_file:
            ...
            try:
                ...
                if (perc_reduc < 0 or perc_reduc > 100):
                    if perc_reduc < 0:
                        print(
                            f"Error: {perc_reduc} is too low. Please enter a different number.")
                    if perc_reduc > 100:
                        print(
                            f"Error: {perc_reduc} is too high. Please enter a different number.")
                    sys.exit()
                print()
                ...
                print(
                    f"Error: could not convert your string to float")
    except FileNotFoundError as err:
        print(f"{err} No such file or directory: '{filename}'")
